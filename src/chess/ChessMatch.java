...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        if (movedPiece instanceof Pawn) {
            if ((movedPiece.getColor() == Color.BRANCO && target.getRow() == 0) || (movedPiece.getColor() == Color.PRETO && target.getRow() == 7)) {
                ...
                promoted = replacePromotedPiece("N");
            }
        }
    ...
    public ChessPiece replacePromotedPiece(String type) {
        ...
        if (!type.equals("B") && !type.equals("C") && !type.equals("T") & !type.equals("N")) {
            return promoted;
        }
    ...
    private ChessPiece newPiece(String type, Color color) {
        ...
        if (type.equals("N")) return new Queen(board, color);
    ...
    private void validateTargetPosition(Position source, Position target) {
        if (!board.piece(source).possibleMove(target)) {
            throw new ChessException("A peça escolhida não pode se mover para a posição do alvo");
        }
    }
